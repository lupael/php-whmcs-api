...
namespace i4e\WhmcsApi\HttpClient\Plugin;

use i4e\WhmcsApi\Exception\AuthenticationException;
use i4e\WhmcsApi\Exception\IpBlockedException;
use i4e\WhmcsApi\HttpClient\Formatter\ResponseFormatter;
